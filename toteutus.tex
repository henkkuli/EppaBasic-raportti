...
Moduuleita käyttämällä voi kirjoittaa
...
Sovelluspalvelin on toteutttu Django-sovelluskehystä \cite{django} (eng. framework)
hyödyntäen. Django perustuu MVC-malliin (Model View Controller),
...
mutta se esitellään erillään muusta käyttöliittymästä,
